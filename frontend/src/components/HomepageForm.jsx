...
function HomepageForm({ formType,buttonText, notifySuccess, notifyError,setIsAuthenticated}){
    ...
    const handleisNotRegisteredSubmit = async (formDataToSend) => {
        try {
            ...
            const response1 = await axios.post('https://gigs-backend.rshare.io/users/updateAccount', formDataToSend, {
                headers: {
            ...
            const response2 = await axios.post('https://gigs-backend.rshare.io/annunci/createAnnuncio', annuncioData, {
                headers: {
    ...
    const handleisRegisteredSubmit = async (event) =>{
        ...
        try {
            const response = await axios.post('https://gigs-backend.rshare.io/annunci/createAnnuncio', annuncioData, {
                headers: {
                    'Content-Type': 'application/json',
                },
                withCredentials: true
