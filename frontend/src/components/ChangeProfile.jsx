...
function ChangeProfile({setButtonStatus, buttonStatus, notifySuccess, notifyError}) {
    ...
    const handleDelete = async () => {
        try {
            await axios.post("https://gigs-backend.rshare.io/users/deleteUserData", {}, { withCredentials: true });
    ...
    const onChangeGeneralData = async (formData) => {
        try {
            await axios.post("https://gigs-backend.rshare.io/users/updateAccount", formData, { withCredentials: true });
